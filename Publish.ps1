...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "p5rpc.FixShadowSettings.csproj",
    $PackageName = "p5rpc.FixShadowSettings",
    ...
    $GitHubUserName = "rebtd7", # Name of the GitHub user where the mod is contained
    $GitHubRepoName = "p5rpc.FixShadowSettings", # Name of the GitHub repo where the mod is contained
    ...
    $GameBananaItemId = 430624, # From mod page URL.

    $NuGetPackageId = "p5rpc.FixShadowSettings",
